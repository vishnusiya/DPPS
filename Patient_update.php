...
{ 
    ...
    $path = "img/" . $filename;
     ...
     if($P_password == $repassword)
     {
      ...
      $query = "UPDATE patient set P_name='$P_name',P_address='$P_address',P_gender='$P_gender',P_age='$P_age',P_mobile='$P_mobile',P_email='$P_email',P_username='$P_username',P_password='$P_password',image='$filename' WHERE P_username='$Patient_user'";
      mysqli_query($con,$query);
        echo"<script>window.location.href='Patient_Logout.php'; alert('User Details Updated!')</script>";
    }
  else {
       ...
       <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                 <li class=""><a href="Patient_details.php">Back</a></li>
              </ul>
            </div>
          </div>
       </div>
         ...
         <div class="box-header with-border">
            ...
            <form class="form-horizontal" method="post"  enctype="multipart/form-data" >
                ...
                <div class="box-footer">
                    <button type="submit" name="P_Register" class="btn btn-info" style="margin-left:150px;">UPDATE</button>
                </div>
            </form>  
