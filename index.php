...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
              ...
              <a href="Patient_Login.php" class="btn btn-appoint">Make an Appointment.</a>
            </div>
          ...
          <div class="col-md-4 col-sm-4 mt-boxy-3">
            ...
            <div class="time-info">
              ...
              <table border="1" style="border: #ffffff medium solid;">
                <tbody>
                  <tr>
                    <td style="padding: 10px;">Monday - Friday</td>
                    <td style="padding: 10px;">8.00 - 17.00</td>
                  </tr>
                  <tr>
                    <td style="padding: 10px;">Saturday</td>
                    <td style="padding: 10px;">9.30 - 17.30</td>
                  </tr>
                  <tr>
                    <td style="padding: 10px;">Sunday</td>
                    <td style="padding: 10px;">9.30 - 15.00</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="section-title">
            <h2 class="head-title lg-line">The DDPS <br>Ultimate Dream</h2>
            <hr class="botm-line">
    ...
    <div class="container">
      <div class=" row">
        ...
        <div class="col-md-4 col-sm-5">
          ...
          <p class="text-right text-primary"><i>— DDPS Healthcare</i></p>
        </div>
        <div class="col-md-2"></div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          ...
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>info@dpps.com</p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+1 800 123 2244</p>
        </div>
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl">Having Any Query! Or Your Feedbacks!</h3>
            <div class="space"></div>
          ...
          <div class="box-footer">
                    <button type="submit" name="feed" class="btn btn-info" ">Send Message</button>
                </div>
  ...
  <section id="login" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="schedule-tab1">
          <div class="col-md-4 col-sm-4">
            <div class="mt-boxy-color"></div>
            <div class="login-info">
            <div class="testi-info">
            <!-- User Image -->
            <a href="Patient_Login.php"><img src="img/Patient.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Patient<span>Login</span></h3>
          </div>
            <p>I am text block. Edit this text from Appearance / Customize / Homepage header columns. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              <a href="Patient_Login.php" class="login-info-btn">Click Here</a>
            </div>
          </div>
          <div class="col-md-4 col-sm-4">
            <div class="login-info">
            <div class="testi-info">
            <!-- User Image -->
            <a href="Doctor_Login.php"><img src="img/Doctor.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Doctor<span>Login</span></h3>
          </div>
           <p>I am text block. Edit this text from Appearance / Customize / Homepage header columns. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              <a href="Doctor_Login.php" class="login-info-btn">Click Here</a>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
            <div class="login-info">
            <div class="testi-info">
            <!-- User Image -->
            <a href="Admin_login.php"><img src="img/Admin.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Admin<span>Login</span></h3>
          </div>
           <p>I am text block. Edit this text from Appearance / Customize / Homepage header columns. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              <a href="Admin_login.php" class="login-info-btn">Click Here</a>
          </div>
        </div>
      </div>
   </div>
          ...
          <div class="col-md-4 col-sm-4 marb20">
            ...
            <div class="info-sec">
              <ul class="quick-info">
                ...
                <li><a href="#contact"><i class="fa fa-circle"></i>Feedback</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4 col-sm-4 marb20">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            © Copyright DPPS Theme. All Rights Reserved
            <div class="credits" style="margin-top: 5px;">
             
              Designed by Dpt Of Computer Engineering GPTC KDY</a>
            </div>
          </div>
        </div>
      </div>
