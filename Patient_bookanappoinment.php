       ...
       ?>
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
                       ...
                       <div class="form-group">
                            <label>Categeory ("click to change")</label><br>
                                    <select class="form-control" name="DA_special" onclick="li_doctor(this.value)"  >
              ...
              <option value="<?php echo $abc["DA_special"];?>"><?php echo $abc["DA_special"];?> </option>
                   <?php } ?>
                        ...
                        <div class="form-group">
                            <label>Doctor's Name ("click to change")</label>
