...
require('config.php');
session_start();   
$doctor_user1=$_SESSION['login_doctor'];

if(isset($_POST['A_search']))
{
  $que = mysqli_query($con,"SELECT * FROM doctors WHERE DA_docid='$doctor_user1'");
  while($row= mysqli_fetch_array($que))
  $name = $row[2];
  $A_Date = $_POST['A_date'];
  $que1 = "SELECT * FROM `patientbook` WHERE PA_date='$A_Date'AND PA_docname='$name'";
  $q51 = mysqli_query($con,$que1);
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
       ...
       <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                ...
                <li class="active"><a href="Doctor_View_Appoinments.php">VIEW APPOINMENTS</a></li>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label  >DATE</label>
                                    ...
                                    <input type="date" class="form-control" name="A_date" placeholder="enter date" required>
                               
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="submit" name="A_search" class="btn btn-info" style="margin-left:110px;">Search</button>
                    </div></div>
                    <div style="margin-left: 300px;">
                          <div class="box box-info">
                            <div class="box-header with-border" style="margin-left: 190px;">
                                <h3 class="box-title">VIEW APPOINMENTS</h3>
                            </div>
                            <div class="box-body">
                       ...
                       <tr style="background-color: #5d0507;color: white;height: 40px;font-size: 16px"> 
                                        ...
                                        <th style="padding:15PX;">Cateogory</th>
